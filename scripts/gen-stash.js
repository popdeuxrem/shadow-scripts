...
const ENV_OUTDIR = process.env.STASH_OUTDIR;
const ENV_OUTPUT = process.env.STASH_OUT;
if (CLI_OUTDIR && (ENV_OUTDIR || ENV_OUTPUT)) {
  console.warn("[WARN] CLI --outdir overrides STASH_OUT/STASH_OUTDIR environment variables.");
}
const DEFAULT_FILENAME = "stash.yaml";
const rawOutput = (() => {
